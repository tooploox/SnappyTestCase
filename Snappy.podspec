Pod::Spec.new do |s|
    ...
    s.description       = <<-DESC
        Snappy combines tests with a set of device definitions (each one including screen size, scale, and orientation) to validate with, ignoring real device simulator context information.
                   DESC
